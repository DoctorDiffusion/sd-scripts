...
def train(args):
    ...
    # Apply hardcoded configurations to T5XXL and CLIP models
    # Assuming flux_utils.load_* returns a model object you can configure
    from transformers import T5Config, CLIPConfig

    # Modify T5XXL configuration
    t5xxl_config = T5Config(
        d_ff=10240,
        d_kv=64,
        d_model=4096,
        num_heads=64,
    ...
    # Assuming `t5xxl` can accept a reloaded configuration
    t5xxl.config = t5xxl_config  # Apply updated configuration if supported
    ...
    clip_l.config = clip_config  # Apply updated configuration if supported
